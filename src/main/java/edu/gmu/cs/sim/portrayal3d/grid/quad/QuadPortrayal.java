...
public abstract class QuadPortrayal implements Portrayal {
    ...
    public static class ObjectFilter extends Filter {
        ...
        public double getValue() {
            return fieldPortrayal.doubleValue(((ObjectGrid2D) fieldPortrayal.getField()).field[x][y]);
        }
    }
    ...
    public static class DoubleFilter extends Filter {
        ...
        public double getValue() {
            return ((DoubleGrid2D) fieldPortrayal.getField()).field[x][y];
        }

        public void setValue(double val) {
            ((DoubleGrid2D) fieldPortrayal.getField()).field[x][y] = fieldPortrayal.newValue(x, y, val);
        }
    }
    ...
    public static class IntFilter extends Filter {
        ...
        public int getValue() {
            return ((IntGrid2D) fieldPortrayal.getField()).field[x][y];
        }

        public void setValue(int val) {
            ((IntGrid2D) fieldPortrayal.getField()).field[x][y] = (int) fieldPortrayal.newValue(x, y, val);
        }
    }
    ...
    public Inspector getInspector(LocationWrapper wrapper, GUIState state) {
        ...
        if (grid instanceof DoubleGrid2D) {
            ...
            return Inspector.getInspector(new ObjectFilter(wrapper), state, "Properties");
        } else {
