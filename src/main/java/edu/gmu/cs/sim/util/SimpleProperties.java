 ...
 *
 * <pre><tt>
 * import edu.gmu.cs.sim.util.Proxiable;
 *
...
public class SimpleProperties extends Properties implements java.io.Serializable {
    ...
    public int numProperties() {
        if (auxillary != null) {
            return auxillary.numProperties();
        }
    ...
    public String getName(int index) {
        if (auxillary != null) {
            return auxillary.getName(index);
        }
        ...
        } else if (name.equals("toString"))   // Strings, StringBuffers
        {
            ...
            return name.substring(3);  // "get", "set"
        }
    }
    ...
    public boolean isReadWrite(int index) {
        if (auxillary != null) {
            return auxillary.isReadWrite(index);
        }
        if (index < 0 || index >= numProperties()) {
            return false;
        }
    ...
    public Class getType(int index) {
        if (auxillary != null) {
            return auxillary.getType(index);
        }
        if (index < 0 || index >= numProperties()) {
            return null;
        }
    ...
    public Object getValue(int index) {
        if (auxillary != null) {
            return auxillary.getValue(index);
        }
        if (index < 0 || index >= numProperties()) {
            return null;
        }
    ...
    protected Object _setValue(int index, Object value) {
        if (auxillary != null) {
            return auxillary.setValue(index, value);  // I think this is right
        }
        try {
            if (setMethods.get(index) == null) {
                return null;
            }
    ...
    public String getDescription(int index) {
        if (auxillary != null) {
            return auxillary.getDescription(index);
        }
        if (index < 0 || index >= numProperties()) {
            return null;
        }
        try {
            if (desMethods.get(index) == null) {
                return null;
            }
    ...
    public Object getDomain(int index) {
        if (auxillary != null) {
            return auxillary.getDomain(index);
        }
        if (index < 0 || index >= numProperties()) {
            return null;
        }
        try {
            if (domMethods.get(index) == null) {
                return null;
            }
    ...
    public boolean isHidden(int index) {
        if (auxillary != null) {
            return auxillary.isHidden(index);
        }
        if (index < 0 || index >= numProperties()) {
            return false;
        }
        try {
            if (hideMethods.get(index) == null) {
                return false;
            }
