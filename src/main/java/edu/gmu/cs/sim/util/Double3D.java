...
public final class Double3D implements java.io.Serializable {
    ...
    public Double3D(final Int2D p) {
        x = p.x;
        y = p.y;
        z = 0.0;
    }

    public Double3D(final Int2D p, final double z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }

    public Double3D(final Int3D p) {
        x = p.x;
        y = p.y;
        z = p.z;
    }
    ...
    /** Explicitly assumes the z value is set to 0 */
    public Double3D(final MutableInt2D p) {
        x = p.x;
        y = p.y;
        z = 0.0;
    }

    public Double3D(final MutableInt2D p, final double z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }

    public Double3D(final MutableInt3D p) {
        x = p.x;
        y = p.y;
        z = p.z;
    }
    ...
    /** Explicitly assumes the z value is set to 0 */
    public Double3D(final Double2D p) {
        x = p.x;
        y = p.y;
        z = 0.0;
    }

    public Double3D(final Double2D p, final double z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }

    public Double3D(final Double3D p) {
        x = p.x;
        y = p.y;
        z = p.z;
    }
    ...
    /** Explicitly assumes the z value is set to 0 */
    public Double3D(final MutableDouble2D p) {
        x = p.x;
        y = p.y;
        z = 0.0;
    }

    public Double3D(final MutableDouble2D p, final double z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }

    public Double3D(final MutableDouble3D p) {
        x = p.x;
        y = p.y;
        z = p.z;
    }

    public Double3D(final double x, final double y, double z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
