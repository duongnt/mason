...
public final class MutableDouble2D implements java.io.Serializable, Cloneable {
    ...
    public MutableDouble2D(final Int2D p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final MutableInt2D p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final MutableDouble2D p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final Double2D p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final java.awt.Point p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final java.awt.geom.Point2D.Double p) {
        x = p.x;
        y = p.y;
    }

    public MutableDouble2D(final java.awt.geom.Point2D.Float p) {
        x = p.x;
        y = p.y;
    }

    /** Only included for completeness' sakes, in case a new Point2D subclass is created in the future. */
    public MutableDouble2D(final java.awt.geom.Point2D p) {
        x = p.getX();
        y = p.getY();
    }

    public MutableDouble2D(final double x, final double y) {
        this.x = x;
        this.y = y;
    }
    ...
    public final void setTo(final double bx, final double by) {
        x = bx;
        y = by;
    }

    public final void setTo(final Int2D b) {
        x = b.x;
        y = b.y;
    }

    public final void setTo(final Double2D b) {
        x = b.x;
        y = b.y;
    }

    public final void setTo(final MutableInt2D b) {
        x = b.x;
        y = b.y;
    }

    public final void setTo(final MutableDouble2D b) {
        x = b.x;
        y = b.y;
    }

    public String toString() {
        return "MutableDouble2D[" + x + "," + y + "]";
    }
