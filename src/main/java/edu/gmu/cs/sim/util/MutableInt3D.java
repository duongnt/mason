...
public final class MutableInt3D implements java.io.Serializable, Cloneable {
    ...
    public MutableInt3D(final int x, final int y, final int z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
    ...
    public MutableInt3D(final Int2D p) {
        x = p.x;
        y = p.y;
        z = 0;
    }

    public MutableInt3D(final Int2D p, final int z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }

    public MutableInt3D(final Int3D p) {
        x = p.x;
        y = p.y;
        z = p.z;
    }

    public MutableInt3D(final MutableInt2D p) {
        x = p.x;
        y = p.y;
        z = 0;
    }

    public MutableInt3D(final MutableInt2D p, final int z) {
        x = p.x;
        y = p.y;
        this.z = z;
    }
