...
public abstract class Properties implements java.io.Serializable {
    ...
    public static Properties getProperties(Object object, boolean expandCollections, boolean includeSuperclasses, boolean includeGetClass, boolean includeExtensions) {
        if (object == null) {
            return new SimpleProperties(object, includeSuperclasses, includeGetClass, includeExtensions);
        }
    ...
    public Object setValue(int index, String value) {
        try {
            ...
            if (type == Boolean.TYPE) {
                return _setValue(index, Boolean.valueOf(value));
            } else if (type == Byte.TYPE) {
                try {
                    return _setValue(index, Byte.valueOf(value));
                } catch (NumberFormatException e) // try again for x.0 stuff
                {
                    double d = Double.parseDouble(value);
                    byte b = (byte) d;
                    if (b == d) {
                        return _setValue(index, Byte.valueOf(b));
                    } else {
                        throw e;
                    }
                }
                ...
                try {
                    return _setValue(index, Short.valueOf(value));
                } catch (NumberFormatException e) // try again for x.0 stuff
                {
                    double d = Double.parseDouble(value);
                    short b = (short) d;
                    if (b == d) {
                        return _setValue(index, Short.valueOf(b));
                    } else {
                        throw e;
                    }
                }
                ...
                try {
                    return _setValue(index, Integer.valueOf(value));
                } catch (NumberFormatException e) // try again for x.0 stuff
                {
                    double d = Double.parseDouble(value);
                    int b = (int) d;
                    if (b == d) {
                        return _setValue(index, Integer.valueOf(b));
                    } else {
                        throw e;
                    }
                }
                ...
                try {
                    return _setValue(index, Long.valueOf(value));
                } catch (NumberFormatException e) // try again for x.0 stuff
                {
                    double d = Double.parseDouble(value);
                    long b = (long) d;
                    if (b == d) {
                        return _setValue(index, Long.valueOf(b));
                    } else {
                        throw e;
                    }
                }
            } else if (type == Float.TYPE) {
                return _setValue(index, Float.valueOf(value));
            } else if (type == Double.TYPE) {
                return _setValue(index, betterDoubleValueOf(value));
            } else if (type == Character.TYPE) {
                return _setValue(index, new Character(value.charAt(0)));
    ...
    */
    ...
    public String betterToString(Object obj) {
        ...
        if (c.isArray()) {
            return typeToName(c) + "@" + Integer.toHexString(obj.hashCode());
        } else {
            return "" + obj;
        }
    }
