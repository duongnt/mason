...
package edu.gmu.cs.sim.app.hexabugs;
...
import edu.gmu.cs.sim.portrayal.SimpleInspector;
import edu.gmu.cs.sim.portrayal.grid.FastHexaValueGridPortrayal2D;
import edu.gmu.cs.sim.portrayal.grid.HexaSparseGridPortrayal2D;
import edu.gmu.cs.sim.portrayal.grid.HexaValueGridPortrayal2D;
...
public class HexaBugsWithUI extends GUIState {
    ...
    public Inspector getInspector() {
        ...
        Inspector newInspector = new Inspector() {
            ...
            }  // don't care about updating hexInspector
        };
    ...
    public void setupPortrayals() {
        ...
        ColorMap map = new SimpleColorMap(0, HexaBugs.MAX_HEAT, Color.black, Color.red);
        ...
        bugPortrayal.setPortrayalForAll(new MovablePortrayal2D(
            new OvalPortrayal2D(Color.white)));   // all the HexaBugs will be white ovals
