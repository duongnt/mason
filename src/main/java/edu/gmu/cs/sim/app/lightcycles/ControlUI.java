...
package edu.gmu.cs.sim.app.lightcycles;
        ...
        lcui.display.insideDisplay.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                    for (int x = 0; x < lc.cycleGrid.allObjects.numObjs; x++) {
                        if (c != null) {
                            ...
                            if (c == ((Cycle) lc.cycleGrid.allObjects.objs[x]) && x != lc.cycleGrid.allObjects.numObjs - 1) {
                                cyclePortrayal.setPortrayalForObject(c, new OvalPortrayal2D(Color.white));
                                c.cpu = true;
                    ...
                    c.cpu = false;
                    cyclePortrayal.setPortrayalForObject(c, new RectanglePortrayal2D(Color.green, 1.5));
