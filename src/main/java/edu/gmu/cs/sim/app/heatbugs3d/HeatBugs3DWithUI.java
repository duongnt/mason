...
package edu.gmu.cs.sim.app.heatbugs3d;

import javax.swing.*;
import java.awt.*;

import edu.gmu.cs.sim.app.heatbugs.HeatBugs;
...
import edu.gmu.cs.sim.portrayal3d.grid.SparseGrid2DPortrayal3D;
...
import edu.gmu.cs.sim.portrayal3d.grid.quad.MeshPortrayal;
import edu.gmu.cs.sim.portrayal3d.grid.quad.QuadPortrayal;
import edu.gmu.cs.sim.portrayal3d.grid.quad.TilePortrayal;
import edu.gmu.cs.sim.portrayal3d.simple.ConePortrayal3D;
import edu.gmu.cs.sim.portrayal3d.simple.TransformedPortrayal3D;
