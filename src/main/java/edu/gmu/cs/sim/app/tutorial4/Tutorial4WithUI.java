...
*/
    ...
    public void setupPortrayals() {
        ...
        particlesPortrayal.setPortrayalForClass(
            Particle.class, new OvalPortrayal2D(Color.green));
        particlesPortrayal.setPortrayalForClass(
            BigParticle.class, new RectanglePortrayal2D(Color.red, 1.5) {
        ...
        particlesPortrayal2.setPortrayalForAll(new RectanglePortrayal2D(Color.green));
