...
package edu.gmu.cs.sim.app.swarmgame;
...
public class SwarmGame extends SimState {
    ...
    public void setGoTowardsA(double val) {
        stalker_v = val;
    }
    ...
    public void setGoAwayFromB(double val) {
        avoider_v = val;
    }
    ...
    public void setGoBetweenAAndB(double val) {
        defender_v = val;
    }
    ...
    public void setGetBehindBFromA(double val) {
        aggressor_v = val;
    }
    ...
    public void setMoveRandomly(double val) {
        random_v = val;
    }
