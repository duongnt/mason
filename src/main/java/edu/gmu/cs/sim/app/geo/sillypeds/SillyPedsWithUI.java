 ...
 **
 ** $Id: SillyPedsWithUI.java 892 2013-04-16 19:04:24Z mcoletti $
 **/
package edu.gmu.cs.sim.app.geo.sillypeds;
...
import edu.gmu.cs.sim.portrayal.grid.FastObjectGridPortrayal2D;
...
//import edu.gmu.cs.sim.portrayal.grid.ObjectGridPortrayal2D;
...
public class SillyPedsWithUI extends GUIState {
    ...
    ColorMap gradientColor = new SimpleColorMap(0, 2000, new Color(237, 246, 250), new Color(36, 44, 53)) {
    ...
    ColorMap traceColor = new SimpleColorMap(0, 2000, new Color(250, 250, 0, 50), new Color(250, 250, 0, 255)) {
        public Color getColor(double level) {
            if (level >= 0) {
                return super.getColor(level);
            } else {
    ...
    ColorMap pedColor = new SimpleColorMap(new Color[]{EMPTY, Color.red});
