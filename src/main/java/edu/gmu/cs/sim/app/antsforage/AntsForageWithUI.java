...
package edu.gmu.cs.sim.app.antsforage;
...
public class AntsForageWithUI extends GUIState {
    ...
    public void setupPortrayals() {
        ...
        homePheromonePortrayal.setMap(new SimpleColorMap(
            0,
        ...
        foodPheromonePortrayal.setMap(new SimpleColorMap(
            0,
            AntsForage.LIKELY_MAX_PHEROMONE,
            new Color(0, 0, 255, 0),
        ...
        sitesPortrayal.setMap(new SimpleColorMap(
            0,
            1,
            new Color(0, 0, 0, 0),
            new Color(255, 0, 0, 255)));
        obstaclesPortrayal.setField(af.obstacles);
        obstaclesPortrayal.setMap(new SimpleColorMap(
            0,
            1,
            new Color(0, 0, 0, 0),
