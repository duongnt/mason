...
package edu.gmu.cs.sim.app.wcss.tutorial14;
...
import edu.gmu.cs.sim.portrayal.network.NetworkPortrayal2D;
import edu.gmu.cs.sim.portrayal.network.SimpleEdgePortrayal2D;
import edu.gmu.cs.sim.portrayal.network.SpatialNetwork2D;
import edu.gmu.cs.sim.portrayal.simple.CircledPortrayal2D;
import edu.gmu.cs.sim.portrayal.simple.LabelledPortrayal2D;
import edu.gmu.cs.sim.portrayal.simple.MovablePortrayal2D;
import edu.gmu.cs.sim.portrayal.simple.OvalPortrayal2D;
import edu.gmu.cs.sim.portrayal3d.continuous.ContinuousPortrayal3D;
import edu.gmu.cs.sim.portrayal3d.network.CylinderEdgePortrayal3D;
import edu.gmu.cs.sim.portrayal3d.network.NetworkPortrayal3D;
import edu.gmu.cs.sim.portrayal3d.network.SimpleEdgePortrayal3D;
import edu.gmu.cs.sim.portrayal3d.network.SpatialNetwork3D;
import edu.gmu.cs.sim.portrayal3d.simple.ConePortrayal3D;
...
public class StudentsWithUI extends GUIState {
    ...
    public void quit() {
        ...
        if (displayFrame3d != null) {
            displayFrame3d.dispose();
        }
        displayFrame3d = null;
        display3d = null;
    }
