 ...
 *
 * $Id: NearbyWorldWithUI.java 680 2012-06-24 21:35:07Z mcoletti $
*/
package edu.gmu.cs.sim.app.geo.nearbyworld;
...
public class NearbyWorldWithUI extends GUIState {
    ...
    public NearbyWorldWithUI(SimState state) {
        super(state);
    }

    public NearbyWorldWithUI() {
        super(new NearbyWorld(System.currentTimeMillis()));
    }
