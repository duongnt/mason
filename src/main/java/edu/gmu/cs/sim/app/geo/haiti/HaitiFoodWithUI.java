...
public class HaitiFoodWithUI extends GUIState {
    ...
    public void start() {
        ...
        // ROADS
        roads.setField(haitifood.roads.getGrid());
        ...
        // DESTRUCTION
        destruction.setField(haitifood.destruction.getGrid());
    ...
    /**
     * Called when first beginning a HaitiFoodWithUI. Sets up the display
