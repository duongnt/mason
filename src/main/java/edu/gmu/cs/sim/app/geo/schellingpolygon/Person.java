 ...
 **
 ** $Id: Person.java 842 2012-12-18 01:09:18Z mcoletti $
 **/
...
public class Person implements Steppable {
    ...
    Polygon bestMove(ArrayList<Polygon> ps) {
        ...
        for (Polygon p : ps) {
            ...
            } else { // otherwise it's an acceptable region and the closest region yet
                result = p;
    ...
    public void step(SimState state) {
        ...
        if (!acceptable(region)) { // the current location is unacceptable
