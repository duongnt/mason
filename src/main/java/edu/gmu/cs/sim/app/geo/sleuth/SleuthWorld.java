 ...
 **
 ** $Id: SleuthWorld.java 842 2012-12-18 01:09:18Z mcoletti $
 **/
package edu.gmu.cs.sim.app.geo.sleuth;
...
import edu.gmu.cs.sim.field.geo.GeomGridField;
import edu.gmu.cs.sim.field.geo.GeomGridField.GridDataType;
import edu.gmu.cs.sim.field.grid.IntGrid2D;
import edu.gmu.cs.sim.field.grid.ObjectGrid2D;
import edu.gmu.cs.sim.io.geo.ArcInfoASCGridImporter;
...
public class SleuthWorld extends SimState {
    ...
    boolean urbanizeTile(Tile t) {
        ...
        if (t.excluded || t.slope > 21) { // can't urbanize a Tile with slope > 21
