...
package edu.gmu.cs.sim.app.heatbugs;
...
*/
	...
	*/
    ...
    public void setupPortrayals() {
        ...
        bugPortrayal.setPortrayalForAll(new MovablePortrayal2D(new OvalPortrayal2D(Color.white)));   // all the heatbugs will be white ovals

        heatPortrayal.setField(((HeatBugs) state).valgrid);
        heatPortrayal.setMap(new SimpleColorMap(0, HeatBugs.MAX_HEAT, Color.black, Color.red));
