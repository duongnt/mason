 ...
 **
 ** $Id: SleuthWorldWithUI.java 842 2012-12-18 01:09:18Z mcoletti $
 **/
...
public class SleuthWorldWithUI extends GUIState {
    ...
    private static ColorMap slopeColor = new SimpleColorMap(
        0, 100, new Color(250, 250, 250), new Color(0, 0, 0));
    private static ColorMap hillshadeColor = new SimpleColorMap(
