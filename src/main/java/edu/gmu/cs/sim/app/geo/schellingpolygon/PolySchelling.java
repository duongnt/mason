 ...
 **
 ** $Id: PolySchelling.java 878 2013-03-28 18:35:54Z joey.f.harrison $
 **/
...
public class PolySchelling extends SimState {
    ...
    void setup() {
        ...
        for (int i = 0; i < polys.size(); i++) {
            ...
            {
                continue;
            } else if (p1.soc.equals("RED")) { // a red Person is initialized here
                Person p = new Person("RED");
                p.updateLocation(p1);
                totalReds++;
                people.add(p);
            } else if (p1.soc.equals("BLUE")) { // a blue Person is initialized here
