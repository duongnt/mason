...
public class SimpleController implements Controller {
    ...
    static {
        ...
        }  // just in case we throw a RuntimeException here
    }
    ...
    public void doClose() {
        ...
        if (Console.allControllers.size() == 0) {
            Console.doQuit();  // we run doQuit on the console to quit gracefully, as it maintains all the controller lists
        }
    }
