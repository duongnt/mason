...
public abstract class GUIState {
    ...
    public int getMaximumPropertiesForInspector() {
        return SimpleInspector.DEFAULT_MAX_PROPERTIES;
    }
    ...
    public Inspector getInspector() {
        ...
        Properties prop = getSimulationProperties();
        if (prop != null) {
    ...
    Stoppable _scheduleImmediateRepeat(boolean immediatelyAfter, Steppable event) {
        ...
        if (scheduleImmediate(immediatelyAfter, r)) {
            return r;
        } else {
            return null;
        }
