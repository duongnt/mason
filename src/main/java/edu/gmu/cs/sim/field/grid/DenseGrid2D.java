...
public class DenseGrid2D extends AbstractGrid2D {
    ...
    public Bag getObjectsAtLocation(Int2D location) {
        return getObjectsAtLocation(location.x, location.y);
    }
    ...
    public Bag removeObjectsAtLocation(Int2D location) {
        return removeObjectsAtLocation(location.x, location.y);
    }
    ...
    public boolean removeObjectAtLocation(final Object obj, Int2D location) {
        return removeObjectAtLocation(obj, location.x, location.y);
    }
    ...
    public boolean removeObjectMultiplyAtLocation(final Object obj, Int2D location) {
        return removeObjectMultiplyAtLocation(obj, location.x, location.y);
    }
    ...
    public boolean moveObject(final Object obj, Int2D from, Int2D to) {
        return moveObject(obj, from.x, from.y, to.x, to.y);
    }
    ...
    public void moveObjects(Int2D from, Int2D to) {
        moveObjects(from.x, from.y, to.x, to.y);
    }
    ...
    public int numObjectsAtLocation(Int2D location) {
        return numObjectsAtLocation(location.x, location.y);
    }
    ...
    public void addObjectToLocation(final Object obj, Int2D location) {
        addObjectToLocation(obj, location.x, location.y);
    }
    ...
    public void addObjectsToLocation(final Bag objs, Int2D location) {
        addObjectsToLocation(objs, location.x, location.y);
    }
    ...
    public void addObjectsToLocation(final Object[] objs, Int2D location) {
        addObjectsToLocation(objs, location.x, location.y);
    }
