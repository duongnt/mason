...
package edu.gmu.cs.sim.field.grid;
...
public class DenseGrid3D extends AbstractGrid3D {
    ...
    public Bag getObjectsAtLocation(Int3D location) {
        return getObjectsAtLocation(location.x, location.y, location.z);
    }
    ...
    public Bag removeObjectsAtLocation(Int3D location) {
        return removeObjectsAtLocation(location.x, location.y, location.z);
    }
    ...
    public boolean removeObjectAtLocation(final Object obj, Int3D location) {
        return removeObjectAtLocation(obj, location.x, location.y, location.z);
    }
    ...
    public boolean removeObjectMultiplyAtLocation(final Object obj, Int3D location) {
        return removeObjectMultiplyAtLocation(obj, location.x, location.y, location.z);
    }
    ...
    public boolean moveObject(final Object obj, Int3D from, Int3D to) {
        return moveObject(obj, from.x, from.y, from.z, to.x, to.y, to.z);
    }
    ...
    public void moveObjects(Int3D from, Int3D to) {
        moveObjects(from.x, from.y, from.z, to.x, to.y, to.z);
    }
    ...
    public int numObjectsAtLocation(Int3D location) {
        return numObjectsAtLocation(location.x, location.y, location.z);
    }
    ...
    public void addObjectToLocation(final Object obj, Int3D location) {
        addObjectToLocation(obj, location.x, location.y, location.z);
    }
    ...
    public void addObjectsToLocation(final Bag objs, Int3D location) {
        addObjectsToLocation(objs, location.x, location.y, location.z);
    }
    ...
    public void addObjectsToLocation(final Object[] objs, Int3D location) {
        addObjectsToLocation(objs, location.x, location.y, location.z);
    }
