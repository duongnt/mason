...
import edu.gmu.cs.sim.display.Manipulating2D;
...
import edu.gmu.cs.sim.portrayal.network.EdgeDrawInfo2D;
...
public class TrailedPortrayal2D extends SimplePortrayal2D {
    ...
    public boolean getOnlyGrowTrailWhenSelected() {
        return onlyGrowTrailWhenSelected;
    }
    ...
    public boolean getOnlyShowTrailWhenSelected() {
        return onlyShowTrailWhenSelected;
    }
