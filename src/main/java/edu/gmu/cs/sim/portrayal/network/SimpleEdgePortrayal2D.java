...
public class SimpleEdgePortrayal2D extends SimplePortrayal2D {
    ...
    public boolean getAdjustsThickness() {
        return adjustsThickness;
    }

    public void setAdjustsThickness(boolean val) {
        adjustsThickness = val;
    }
    ...
    public void setScaling(int val) {
        if (val >= NEVER_SCALE && val <= ALWAYS_SCALE) {
            scaling = val;
        }
    }
    ...
    public void draw(Object object, Graphics2D graphics, DrawInfo2D info) {
        ...
        if (shape == SHAPE_TRIANGLE) {
            ...
            if (info.precise) {
                ...
                xPoints[1] = (int) (startXd + (vecY) * scaleWidth);
                yPoints[1] = (int) (startYd + (-vecX) * scaleHeight);
                xPoints[2] = (int) (startXd + (-vecY) * scaleWidth);
                yPoints[2] = (int) (startYd + (vecX) * scaleHeight); // rotate 180 degrees
