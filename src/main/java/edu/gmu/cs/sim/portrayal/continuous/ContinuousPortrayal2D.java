...
package edu.gmu.cs.sim.portrayal.continuous;
...
import edu.gmu.cs.sim.portrayal.Fixed2D;
...
public class ContinuousPortrayal2D extends FieldPortrayal2D {
    ...
    public boolean getDrawsFrameAndAxesInFront() {
        return drawsFrameAndAxesInFront;
    }

    public void setDrawsFrameAndAxesInFront(boolean val) {
        drawsFrameAndAxesInFront = val;
    }
    ...
    protected void hitOrDraw(Graphics2D graphics, DrawInfo2D info, Bag putInHere) {
        ...
        if (!drawsFrameAndAxesInFront) {
            drawFrameAndAxes(graphics, info);
        }
