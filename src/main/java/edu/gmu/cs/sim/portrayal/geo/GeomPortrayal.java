 ...
 *
 * $Id: GeomPortrayal.java 674 2012-06-22 21:28:28Z mcoletti $
 * 
*/
package edu.gmu.cs.sim.portrayal.geo;
...
import edu.gmu.cs.sim.portrayal.inspector.TabbedInspector;
...
public class GeomPortrayal extends SimplePortrayal2D {
    ...
    GeneralPath drawPolygon(Polygon polygon, GeomInfo2D info, boolean fill) {
        ...
        for (int i = 0; i < polygon.getNumInteriorRing(); i++) { // fill for internal rings will always be false as they are literally
