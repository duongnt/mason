...
public class ShapePortrayal2D extends AbstractShapePortrayal2D {
    ...
    public void draw(Object object, Graphics2D graphics, DrawInfo2D info) {
        ...
        } else   // faster by far         // NOTE:  Not any more.  On the Mac it's about 1% faster, not enough to worry about.
        {
            ...
            if (filled) {
                graphics.fillPolygon(translatedXPoints, translatedYPoints, translatedXPoints.length);
            } else {
                graphics.drawPolygon(translatedXPoints, translatedYPoints, translatedXPoints.length);
            }
        }
    }
