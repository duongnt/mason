...
package edu.gmu.cs.sim.portrayal.grid;
...
public class FastHexaObjectGridPortrayal2D extends HexaObjectGridPortrayal2D {
    ...
    /** @deprecated Resets the underlying FastHexaValueGridPortrayal2D. */
    public void reset() {
        valueGridPortrayal.reset();
    }

    public void setDirtyField(boolean val) {
        valueGridPortrayal.setDirtyField(val);
    }

    public boolean isDirtyField() {
        return valueGridPortrayal.isDirtyField();
    }

    public ColorMap getMap() {
        return valueGridPortrayal.getMap();
    }

    public void setMap(ColorMap m) {
        valueGridPortrayal.setMap(m);
    }

    public int getBuffering() {
        return valueGridPortrayal.getBuffering();
    }

    public void setBuffering(int val) {
        valueGridPortrayal.setBuffering(val);
    }
